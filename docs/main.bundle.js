...
// Module
exports.push([module.i, "body {\n  display: grid;\n  font-family: 'Open Sans', sans-serif;\n  grid-template-rows: 10% 65% 4% 17% 4%;\n  height: 1200px;\n}\n\nheader {\n  background-color: blue;\n  grid-row: 1;\n}\n\nh1 {\n  color: #fff;\n  font-size: 4em;\n  margin: 5px auto;\n  text-align: center;\n}\n\nmain {\n  align-content: center;\n  display: grid;\n  grid-row: 2;\n  grid-template-rows: 6% 94%;\n}\n\n.user-answer-form, .current-answer {\n  grid-row: 1;\n  margin-top: 10px;\n  text-align: center;\n}\n\n#user-answer {\n  width: 250px;\n}\n\n.answer-submit {\n  height: 27px;\n}\n\n.hidden {\n  visibility: hidden;\n}\n\n.board  {\n  border: 2px solid black;\n  display: grid;\n  grid-row: 3;\n  grid-template-columns: 25% 25% 25% 25%;\n  grid-template-rows: 20% 20% 20% 20% 20%;\n  height: 90%;\n  margin: 30px auto;\n  text-align: center;\n  width: 90%;\n}\n\nh2 {\n  color: #fff;\n}\n\narticle {\n  background-color: gray;\n  border: 2px black solid;\n}\n\nh3 {\n  color: #fff;\n  font-size: 2.25em;\n  margin: 40px 0;\n  padding-bottom: 40px;\n}\n\n.col {\n  color: #fff;\n  font-size: 1.10em;\n}\n\n.col:hover {\n  background-color: blue;\n}\n\n.round {\n  grid-row: 3;\n  margin-top: 15px;\n}\n\nh4 {\n  font-size: 2em;\n  margin: 0;\n  margin-top: 15px;\n  text-align: center;\n}\n\n.players {\n  display: grid;\n  grid-row: 4;\n  grid-template-columns: 1fr 1fr 1fr ;\n  margin-top: 15px;\n}\n\n.player-one {\n  grid-column: 1;\n}\n\n.player-two {\n  grid-column: 2;\n}\n\n.player-three {\n  grid-column: 3;\n}\n\n.player-name {\n  margin-bottom: 10px;\n}\n\n.eachPlayer {\n   margin-top: 20px;\n   text-align: center;\n}\n\nlabel {\n  font-size: 1.25em;\n}\n\n.player-input {\n  height: 20px;\n  margin-top: 10px;\n  width: 65%;\n}\n\nh5 {\n  font-size: 1.25em;\n  margin-top: 7px;\n  margin: 0;\n}\n\nh6 {\n  font-size: 3.25em;\n  margin: 0;\n}\n\nfooter {\n  grid-row: 5;\n  text-align: center;\n}\n\n.start, .quit {\n  font-size: 1.1em;\n  height: 30px;\n  margin: 0 20px 20px;\n  width: 200px;\n}\n\nbutton:hover {\n  background-color: blue;\n  color: #fff;\n}", ""]);
...
/* harmony import */ var _Game_Data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Game-Data.js */ "./src/Game-Data.js");
...
/* harmony import */ var _Round_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Round.js */ "./src/Round.js");
...
class Game {
  ...
  getPlayerNames(names) {
    const players = names.map(name => {
      let newPlayer = new _Player_js__WEBPACK_IMPORTED_MODULE_3__["default"](name);
      return newPlayer;
    });
    this.currentPlayers = players;
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].updatePlayerNames(this.currentPlayers);
  }

  setRoundOne() {
    let newRound = new _Round_js__WEBPACK_IMPORTED_MODULE_4__["default"](this);
    newRound.setCategories(this);
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].appendCategoryNames(this);
    newRound.createCards(this);
    newRound.sortQuestions(this);
  }

  compareAnswers(cardValue) {
    let userInput = jquery__WEBPACK_IMPORTED_MODULE_6___default()("#user-answer").val().toLowerCase();
    let realAnswer = jquery__WEBPACK_IMPORTED_MODULE_6___default()(".answer").text().toLowerCase();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_6___default()(".current-answer").removeClass("hidden");
    jquery__WEBPACK_IMPORTED_MODULE_6___default()("#user-answer").val("");
    this.isAnswered = true;
  }
  ...
  changePlayer() {
    if (this.currentPlayerIndex === 0) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_6___default()(".player-two-name").css({"color": "blue", "font-size": "200%", "font-weight": "bold"});
      jquery__WEBPACK_IMPORTED_MODULE_6___default()(".player-one-name").css({"color": "", "font-size": "", "font-weight": ""});
    } else if (this.currentPlayerIndex === 1) {
      this.currentPlayerIndex = 2;
      jquery__WEBPACK_IMPORTED_MODULE_6___default()(".player-three-name").css({"color": "blue", "font-size": "200%", "font-weight": "bold"});
      jquery__WEBPACK_IMPORTED_MODULE_6___default()(".player-two-name").css({"color": "", "font-size": "", "font-weight": ""});
    } else if (this.currentPlayerIndex === 2) {
      this.currentPlayerIndex = 0;
      jquery__WEBPACK_IMPORTED_MODULE_6___default()(".player-one-name").css({"color": "blue", "font-size": "200%", "font-weight": "bold"});
      jquery__WEBPACK_IMPORTED_MODULE_6___default()(".player-three-name").css({"color": "", "font-size": "", "font-weight": ""});
    }
  }
...
class Player {
  ...
  scoreChangeUp(cardValue) {
    ...
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateScore(this);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Game_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Game.js */ "./src/Game.js");
/* harmony import */ var _Game_Data_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Game-Data.js */ "./src/Game-Data.js");
...
class Round {
	...
	setCategories(game) {
        const categoryData = Object.entries(_Game_Data_js__WEBPACK_IMPORTED_MODULE_1__["default"].categories);
    ...
    createCards(game) {
        ...
        game.roundOneCategories.forEach(category => {
            const matchingClues = _Game_Data_js__WEBPACK_IMPORTED_MODULE_1__["default"].clues.filter(clue => {
            ...
            var newCard = new _Card_js__WEBPACK_IMPORTED_MODULE_2__["default"](answer, categoryId, pointValue, question);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  updatePlayerNames(names) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-one-name").text(names[0].name);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-two-name").text(names[1].name);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-three-name").text(names[2].name);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-input").remove();
  },
  ...
  appendCategoryNames(game) {
    ...
    game.roundOneCategories.forEach(category => {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".category-one").text(fancyCategoryNames[0]);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".category-two").text(fancyCategoryNames[1]);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".category-three").text(fancyCategoryNames[2]);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".category-four").text(fancyCategoryNames[3]);
  },

  loadQuestion(e, game) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target.className);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.${cardClicked}`).text(game[targetColumn][targetRow].question);
    game.isAnswered = false;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".answer").text(game[targetColumn][targetRow].answer);
  },

  updateScore(player) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-name").each( (index, currentPlayer) => {
      if(jquery__WEBPACK_IMPORTED_MODULE_0___default()(currentPlayer).text() === player.name) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(currentPlayer).next().next().next().text(player.score);
      }
    });
  }
...
const game = new _Game_js__WEBPACK_IMPORTED_MODULE_3__["default"];
const startBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".start");
const quitBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".quit")
const card = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".col");
let answerSubmit = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".answer-submit");
let cardValue;

startBtn.click(function(e) {
  e.preventDefault();
  const names = [jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-one-input").val(), jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-two-input").val(), jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-three-input").val()];
  const playerOneName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".player-one-name").css({"color": "blue", "font-size": "200%", "font-weight": "bold"})
  game.getPlayerNames(names);
  game.setRoundOne();
});

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.board').click(function(e){
  cardValue = parseInt(jquery__WEBPACK_IMPORTED_MODULE_0___default()(`h3.${e.target.classList[0]}`)[0].innerHTML);
});

card.click(function(e) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".current-answer").addClass("hidden");
  if (game.isAnswered) {
    setTimeout(function() {
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_4__["default"].loadQuestion(e, game);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".user-answer-form").removeClass("hidden");
    }, 100)
  }
});
